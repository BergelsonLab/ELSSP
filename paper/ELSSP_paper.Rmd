...
<!-- ec: watch out for laterality, communication, dev concerns, premature, monolingual, etiology, amplification

still need to remove mixed HL and cued speech-->
...
ec: no :( 
okay, this is maybe not true anymore -->
...
*Add paragraph here about how while this overlap is not necessarily surprising, it should tell us to be careful. how replicable are controlled lab samples when X% of children with X have Y*
...
Infants from Spanish-speaking families were diagnosed `r abs(summary(services_aic)$coefficients[3,1])` months later than infants from English-speaking families. This may be due to cultural differences in attitudes towards deafness [@caballero2018; @steinberg1997, @steinberg2003; @rodriguez2018] or it may result from a lack of linguistically accessible and culturally appropriate audiology services (CITE). Only 5.6% of American audiologists identify as a bilingual service provider [@asha2019], and services from a monolingual provider may be insufficient. @caballero2017 found that Hispanic-American parents of DHH children want more concrete resources, comprehensive information, and emotional support from their audiologist. The majority of audiologists in a survey responded that they use ad-hoc interpreters (e.g., client’s family) to overcome language barriers. Survey respondents reported that language barriers presented a major challenge in working with Spanish-speaking families, specifically in obtaining the child’s case history and providing recommendations for follow-up services [@abreu2011]. Compounding this issue, Hispanic-Americans infants may be more likely to than non-Hispanic-American infants to experience hearing loss [@mehra2009].

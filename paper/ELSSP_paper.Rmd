...
library(dotwhisker)
library(car)
knitr::opts_chunk$set(fig.width=6, fig.height=6, fig.pos="p", comment=F, message=F, hide = T, warning = F, echo = F)
```
...
Our full regression model included all variables: Vocabulary Delay ~ Gender + Developmental Delay + Health Issues + Prematurity + Laterality + Degree + Amplification + Communication + Meets 1-3-6 + Services Received Per Month + Language Background. 

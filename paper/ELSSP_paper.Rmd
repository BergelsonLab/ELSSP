...
Bonferroni-corrected alpha for this set of analyses was p < 0.0007. Of the `r nrow(chi_sq_all)` combinations of variables, p < .05 for `r nrow(chi_sq_all %>% filter(p.value<.05))`, and `r nrow(chi_sq_all %>% filter(p.value<.000757))` survived bonferroni correction. We are only discussing the results of tests that survived bonferroni correction, but the full set of results can be found in figure \@ref(fig:relationships-plot).

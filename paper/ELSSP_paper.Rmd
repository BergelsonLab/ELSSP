...
From this analysis, we found that children born premature were more likely to also have health issues (X2 (df, N = ) = , p = .) Children with conductive hearing loss were more likely to have unilateral hearing loss (X2 (df, N = ) = , p = ). Children with unilateral hearing loss were unlikely to receive a cochlear implant and more likely to use no amplification (X2 (df, N = ) = , p = ). Children with more severe hearing loss were more likely to use a cochlear implant than children with milder hearing loss (U=, p=). Children with developmental delays (U =, p =) received more services per month than typically developing DHH children and were more likely to use total communication (X2 (df, N = ) = , p = ). Children who used total communication received more services per month than children using spoken language (X2 (df, N = ) = , p = ).
...
perc_136_TD <- (nrow(full_elssp%>%filter(Meets136=='yes'))/(nrow(full_elssp %>% filter(Meets136=='yes'|Meets136=='no')))*100
perc_136_DA <- (nrow(full_elssp%>%filter(Meets136=='yes'))/(nrow(full_elssp %>% filter(Meets136=='yes'|Meets136=='no')))*100
```

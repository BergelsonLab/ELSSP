...
tribble(
  ...
  glue('WG (n={nrow(elssp_curves %>% filter(CDIversion=="WG"))})'), glue('{round(mean((elssp_curves %>% filter(CDIversion=="WG"))$Age), digits=2)} ({round(sd((elssp_curves %>% filter(CDIversion=="WG"))$Age), digits=2)}) months'), glue('{round(mean((elssp_curves %>% filter(CDIversion=="WG"))$ComprehensionCDI, na.rm = TRUE), digits=0)} ({round(sd((elssp_curves %>% filter(CDIversion=="WG"))$ComprehensionCDI, na.rm = TRUE), digits=1)}) words'), glue('{round(mean((elssp_curves %>% filter(CDIversion=="WG"))$ProductionCDI, na.rm = TRUE), digits=0)} ({round(sd((elssp_curves %>% filter(CDIversion=="WG"))$ProductionCDI, na.rm = TRUE),digits=1)}) words'), glue('{round(((nrow((elssp_curves %>% filter(CDIversion=="WG")) %>% filter(DevelopmentalConcerns=="yes")))/(nrow((elssp_curves %>% filter(CDIversion=="WG")))))*100, digits=2)}%'),
  glue('WS (n={nrow((elssp_curves %>% filter(CDIversion=="WS")))})'), glue('{round(mean((elssp_curves %>% filter(CDIversion=="WS"))$Age), digits=2)} ({round( sd((elssp_curves %>% filter(CDIversion=="WS"))$Age), digits=2)}) months'), 'NA', glue('{round(mean((elssp_curves %>% filter(CDIversion=="WS"))$ProductionCDI, na.rm = TRUE), digits=0)} ({round(sd((elssp_curves %>% filter(CDIversion=="WS"))$ProductionCDI, na.rm = TRUE), digits=1)}) words'), glue('{round(((nrow((elssp_curves %>% filter(CDIversion=="WS")) %>% filter(DevelopmentalConcerns=="yes")))/(nrow((elssp_curves %>% filter(CDIversion=="WS")))))*100, digits=2)}%')) %>%

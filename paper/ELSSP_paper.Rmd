...
From this analysis, we found that children born premature were more likely to also have health issues `r chisq_output("IsPremature","HealthIssues")`. Children with conductive hearing loss were more likely to have unilateral hearing loss `r chisq_output("Laterality","Etiology")`. Children with unilateral hearing loss were unlikely to receive a cochlear implant and more likely to use no amplification `r chisq_output("Laterality","Amplification")`. Children with more severe hearing loss were more likely to use a cochlear implant than children with milder hearing loss `r chisq_output("HLworse_cat", "Amplification")`. Children with developmental delays received more services per month than typically developing DHH children `r chisq_output("DevelopmentalConcerns", "SPM_cat")` and were more likely to use total communication `r chisq_output("DevelopmentalConcerns","Communication")`. Children who used total communication received more services per month than children using spoken language `r chisq_output("Communication", "SPM_cat")`.

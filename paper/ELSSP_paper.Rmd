...
delay_table <- tribble(
  ...
  'Gender', glue('Boy: {mean((wg_elssp %>% filter(Gender=="male"))$diff_age_from_expected)}; Girl: {mean((wg_elssp %>% filter(Gender=="female"))$diff_age_from_expected)}'), glue('Boy: {mean((ws_elssp %>% filter(Gender=="male"))$diff_age_from_expected)}; Girl: {mean((ws_elssp %>% filter(Gender=="female"))$diff_age_from_expected)}'), 'wilcox', 
 'Laterality', glue('Unilateral: {mean((wg_elssp %>% filter(Laterality=="Unilateral"))$diff_age_from_expected)}; Bilateral: {mean((wg_elssp %>% filter(Laterality=="Bilateral"))$diff_age_from_expected)}'), glue('Unilateral: {mean((ws_elssp %>% filter(Laterality=="Unilateral"))$diff_age_from_expected)}; Bilateral: {mean((ws_elssp %>% filter(Laterality=="Bilateral"))$diff_age_from_expected)}'), 'wilcox',
    'Amplification', glue('CI: {mean((wg_elssp %>% filter(Amplification=="CI"))$diff_age_from_expected)}; HA: {mean((wg_elssp %>% filter(Amplification=="HA"))$diff_age_from_expected)}, none: {mean((wg_elssp %>% filter(Amplification=="none"))$diff_age_from_expected)}'), glue('CI: {mean((ws_elssp %>% filter(Amplification=="CI"))$diff_age_from_expected)}; HA: {mean((ws_elssp %>% filter(Amplification=="HA"))$diff_age_from_expected)}, none: {mean((ws_elssp %>% filter(Amplification=="none"))$diff_age_from_expected)}'),'kruskall',
   'Health Issues', glue('Yes: {mean((wg_elssp %>% filter(HealthIssues==1))$diff_age_from_expected)}; No: {mean((wg_elssp %>% filter(HealthIssues==0))$diff_age_from_expected)}'), glue('Yes: {mean((ws_elssp %>% filter(HealthIssues==1))$diff_age_from_expected)}; No: {mean((ws_elssp %>% filter(HealthIssues==0))$diff_age_from_expected)}'), 'wilcox',
   'Developmental Delay', glue('Yes: {mean((wg_elssp %>% filter(DevelopmentalConcerns=="yes"))$diff_age_from_expected)}; No: {mean((wg_elssp %>% filter(DevelopmentalConcerns=="no"))$diff_age_from_expected)}'), glue('Yes: {mean((ws_elssp %>% filter(DevelopmentalConcerns=="yes"))$diff_age_from_expected)}; No: {mean((ws_elssp %>% filter(DevelopmentalConcerns=="no"))$diff_age_from_expected)}'), 'wilcox', 
    'Prematurity', glue('Premature: {mean((wg_elssp %>% filter(IsPremature==1))$diff_age_from_expected)}; Full-term: {mean((wg_elssp %>% filter(IsPremature==0))$diff_age_from_expected)}'), glue('Premature: {mean((ws_elssp %>% filter(IsPremature==1))$diff_age_from_expected)}; Full-term: {mean((ws_elssp %>% filter(IsPremature==0))$diff_age_from_expected)}'), 'wilcox',
   '1-3-6 Guidelines', glue('Meets: {mean((wg_elssp %>% filter(Meets136=="yes"))$diff_age_from_expected)}; Does not meet: {mean((wg_elssp %>% filter(Meets136=="no"))$diff_age_from_expected)}'), glue('Meets: {mean((ws_elssp %>% filter(Meets136=="yes"))$diff_age_from_expected)}; Does not meet: {mean((ws_elssp %>% filter(Meets136=="no"))$diff_age_from_expected)}'), 'wilcox',
  'Communication', glue('Spoken Language: {mean((wg_elssp %>% filter(Communication=="spoken"))$diff_age_from_expected)}; Total Communication: {mean((wg_elssp %>% filter(Communication=="total communication"))$diff_age_from_expected)}'),  glue('Spoken Language: {mean((ws_elssp %>% filter(Communication=="spoken"))$diff_age_from_expected)}; Total Communication: {mean((ws_elssp %>% filter(Communication=="total communication"))$diff_age_from_expected)}'),'wilcox',
  'Etiology', glue('SNHL: {mean((wg_elssp %>% filter(Etiology=="SNHL"))$diff_age_from_expected)}; Mixed: {mean((wg_elssp %>% filter(Etiology=="Mixed"))$diff_age_from_expected)}, Conductive: {mean((wg_elssp %>% filter(Etiology=="Conductive"))$diff_age_from_expected)}'), glue('SNHL: {mean((ws_elssp %>% filter(Etiology=="SNHL"))$diff_age_from_expected)}; Mixed: {mean((ws_elssp %>% filter(Etiology=="Mixed"))$diff_age_from_expected)}, Conductive: {mean((ws_elssp %>% filter(Etiology=="Conductive"))$diff_age_from_expected)}'),'kruskall',
  'Degree', glue('More severe: {mean((wg_elssp %>% filter(HLworse>64))$diff_age_from_expected)}; Less severe: {mean((wg_elssp %>% filter(HLworse<64))$diff_age_from_expected)}'),  glue('More severe: {mean((ws_elssp %>% filter(HLworse>56))$diff_age_from_expected)}; Less severe: {mean((ws_elssp %>% filter(HLworse<56))$diff_age_from_expected)}'),'wilcox',
   'Services Received Per Month', glue('More services: {mean((wg_elssp %>% filter(ServicesReceivedPerMonth>4))$diff_age_from_expected)}; Less services: {mean((wg_elssp %>% filter(ServicesReceivedPerMonth<4))$diff_age_from_expected)}'),  glue('More services: {mean((ws_elssp %>% filter(ServicesReceivedPerMonth>2))$diff_age_from_expected)}; Less services: {mean((ws_elssp %>% filter(ServicesReceivedPerMonth<2))$diff_age_from_expected)}'),'wilcox'
)
...
```{r diagnosis_betas}
diagnosis_aic <- lm(formula = IdentificationOfHLMonths ~ HealthIssues + Monolingual_English, data = elssp)
...
services_aic <- lm(formula = AgeStartedServices ~ HLworse + Laterality + IsPremature + IdentificationOfHLMonths, data = (data = elssp %>% filter(HLworse != "NA")))

...
The best fit model (R2=`r summary(services_aic)$r.squared` , p=`r lm_pvalue(services_aic)`) included prematurity `r beta_output(services_aic, 4)`, laterality `r beta_output(services_aic, 3)`, degree of hearing loss `r beta_output(services_aic, 2)`, and age at diagnosis `r beta_output(services_aic, 5)`.

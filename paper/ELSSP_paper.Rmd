...
This model accounted for roughly `r summary(AIC_model_delay)$r.squared`% of the variance in children’s vocabulary delay. Although we showed in Part I that relationships exist among several of these variables (e.g., degree and amplification), a vif test on our model revealed that each predictor was responsible for a unique share of the variance.
...
services_aic <- lm(formula = AgeStartedServices ~ HLworse + IsPremature + 
                       IdentificationOfHLMonths + Monolingual_English, data = full_elssp)

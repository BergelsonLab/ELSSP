...
```{r balloon-plots}
#I'm not sure what to do with these. I think they do show the distributions, but they're not particularly pretty, and I can't figure out how to remove the bars on the sides. i think i can make them better in ggplot, so that's my next step.
...
full_model_delay <- lm(diff_age_from_expected ~ Gender + DevelopmentalConcerns + HealthIssues + IsPremature + Laterality + HLworse + Amplification + Communication + Meets136, data = (full_elssp %>% filter(PrimaryLanguage == 'English' & Meets136!='')))

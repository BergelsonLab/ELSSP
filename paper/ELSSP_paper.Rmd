...
```{r beta-plots, fig.cap="Unstandardized beta weights (months) for the models of (A) vocabulary delay, (B) age at diagnosis, (C) age, selected by AIC. A: Vocabulary Delay ~ Age + Laterality + Amplification; B:  Age at Diagnosis ~ Health Issues + Language Background + Laterality; C: Age at Intervention ~ Degree + Prematurity + Language Background + Age at Diagnosis."}

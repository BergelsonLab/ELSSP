...
Lastly, we looked at the ages at which children received diagnosis and intervention, and how this mapped onto the 1-3-6 guidelines. XXX% of our sample met 1-3-6 guidelines for early diagnosis and intervention. Of children with comorbidities (developmental concerns, prematurity, health issues), only XXX% met 1-3-6 guidelines, compared to XXX% of typically developing children. See table XXX for complete breakdown.
...
The best fit model (R2= , p= )included health issues (beta weight, p = ) and language background (beta = , p = ).
...
The best fit model (R2= , p= )included prematurity (beta weight, p = ), laterality (beta weight, p = ), degree of hearing loss (beta weight, p = ), and age at diagnosis (beta = , p = ). 

...
\textbf{Results}: We found this sample showed spoken language vocabulary delays relative to hearing peers and room for improvement in rates of early diagnosis and intervention. Critically, we also found that these delays in vocabulary and early support services were predicted by a subset of demographic, audiological, and clinical variables.
...
\caption{\label{fig:beta-plots}Unstandardized beta weights (months) for the models of (A) vocabulary delay, (B) age at diagnosis, (C) age, selected by AIC.}
\end{figure}

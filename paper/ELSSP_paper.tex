...
\caption{\label{tab:diagnosis-betas}Unstandardized beta coefficients (months) for the model of age at diagnosis selected by AIC: Age at Diagnosis ~ Health Issues + Language Background + Laterality.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
...
\caption{\label{tab:intervention-betas}Unstandardized beta coefficients (months) for the model of age at intervention selected by AIC: Age at Intervention ~ Degree + Prematurity + Language Background + Age at Diagnosis.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
...
\caption{\label{fig:beta-plots}Unstandardized beta weights (months) for the models of (A) vocabulary delay, (B) age at diagnosis, (C) age, selected by AIC. A: Vocabulary Delay \textasciitilde{} Age + Laterality + Amplification; B: Age at Diagnosis \textasciitilde{} Health Issues + Language Background + Laterality; C: Age at Intervention \textasciitilde{} Degree + Prematurity + Language Background + Age at Diagnosis.}
\end{figure}

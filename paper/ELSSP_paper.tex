...
\caption{\label{tab:CDIsummary}Summary of prior findings examining CDI vocabulary in DHH children.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|l|l|l|l|l|l}
\hline
Study & Population & Gender & 1-3-6 & Degree & Amplification & Comorbidities\\
\hline
Yoshinaga-Itano et al., 2017 & 8-39 m.o.'s with bilateral hearing loss & No effect & 1-3-6 + & More severe - & NA & Comorbidities -\\
\hline
Yoshinaga-Itano et al., 2018 & Children with CIs & NA & 1-3-6 + & NA & Earlier CI activation + & NA\\
\hline
De Diego-Lazaro et al., 2018 & Spanish speaking children with bilateral hearing loss & No effect & Earlier intervention + & Milder + & More functional hearing + & NA\\
\hline
Vohr et al., 2011 & 18-24 m.o.'s with hearing loss & NA & Earlier intervention + & Milder + & NA & NICU stay -; Comorbidities -\\
\hline
\multicolumn{7}{l}{\textsuperscript{a} + equals bigger vocab, - equals smaller vocab}\\
\multicolumn{7}{l}{\textsuperscript{b} N.B. laterality \& communication type were not examined in these studies}\\
\end{tabular}}
\end{table}
...
\caption{\label{tab:CDIinfo}CDI result summary. For each version of the CDI (WG = Words and Gestures; WS = Words and Sentences), the table shows the mean(SD) age, comprehension score, and production score of participants in our sample, along with the percent diagnosed with developmental delays.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|l|l|l|l}
\hline
CDI version & Mean Age (SD) & Mean Comprehension (SD) & Mean Production (SD) & \% Developmental Delays\\
\hline
WG (n=74) & 20.05 (8.82) months & 105 (99.7) words & 32 (53.4) words & 18.9\%\\
\hline
WS (n=24) & 26.03 (7.78) months & NA & 149 (180.1) words & 4.2\%\\
\hline
\end{tabular}}
\end{table}

\begin{longtable}[t]{l|l|r}
\caption{\label{tab:comorbid-info}Additional Diagnoses (n=39): Ns of participants in our sample diagnosed with other conditions. N.B.: Ns do not sum to total because many participants had multiple diagnoses.}\\
\hline
...
\caption{\label{tab:comm-info}Language and Communication Characteristics of the Sample: Ns of participants by language background and communication method.}
\centering
...
Communication method was recorded as spoken language, total communication, or cued speech. One participant had a parent fluent in sign language, but the reported communication method in the home was total communication. No child in our sample used American Sign Language or another signed language. The forms also listed the primary language spoken at home, which we binned into English-speaking and non-English-speaking. 85 out of the 100 had a primary language of English, while 14had Spanish. The remaining child was adopted from a non-English-speaking country after age 2 and had heard mostly non-English by the time of assessment; this child was coded as non-English-speaking. Language and communication information is summarized in Table \ref{tab:comm-info}.

\begin{table}[!h]

\caption{\label{tab:meets136-info}Meets 1-3-6 Information: Percent of the sample meeting diagnosis and/or intervention guidelines, and average age diagnosis/intervention was provided.}
\centering
\begin{tabular}[t]{l|l}
\hline
 & \\
...
\caption{\label{tab:variables-list}Detailed information about the variables studied. For categorical variables, levels are described. For continuous variables, range, mean, and standard deviation are provided.}
\centering
\resizebox{\linewidth}{!}{
...
\hypertarget{relationships-among-demographic-audiological-and-clinical-variables}{%
\subsection{Relationships Among Demographic, Audiological, and Clinical Variables}\label{relationships-among-demographic-audiological-and-clinical-variables}}
...
\caption{\label{fig:relationships-plot}Results of chi-square tests between variables. X- and y-axes show the variables compared. Color of the square represents significance of the corresponding chi-square test. For tests that survived Bonferroni correction (p\textless.0007), effect size (Cramer's V) is given.}
\end{figure}
...
\hypertarget{predictors-of-vocabulary-delay}{%
\subsection{Predictors of Vocabulary Delay}\label{predictors-of-vocabulary-delay}}

\begin{figure}
\centering
\includegraphics{ELSSP_paper_files/figure-latex/english-curves-1.pdf}
\caption{\label{fig:english-curves}Lines show the growth curves created from Wordbank American English 50th percentile data. Left panel shows Words \& Gestures; right panel shows Words \& Sentences. Dots represent vocabulary scores of individual DHH children in the sample.}
\end{figure}

\begin{figure}
\centering
\includegraphics{ELSSP_paper_files/figure-latex/spanish-curves-1.pdf}
\caption{\label{fig:spanish-curves}Lines show the growth curves created from Wordbank Mexican Spanish 50th percentile data. Left panel shows Words \& Gestures; right panel shows Words \& Sentences. Dots represent vocabulary scores of individual DHH children in the sample.}
\end{figure}
...
\caption{\label{tab:full-delay-betas}Unstandardized beta weights (months of vocabulary delay) for model of vocabulary delay with all variables included: Vocabulary Delay ~ Gender + Developmental Delay + Health Issues + Premature Birth + Laterality + Degree + Amplification + Communication + Meets 1-3-6 + Services Received Per Month + Language Background.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
\hline
(Intercept) & -4.1743990 & 5.1699239 & -0.8074392 & 0.4224043\\
\hline
Gendermale & 0.4855404 & 1.1952929 & 0.4062104 & 0.6859431\\
\hline
DevelopmentalConcernsyes & 1.8835097 & 1.6350361 & 1.1519683 & 0.2536192\\
\hline
IsPrematureyes & 0.2918937 & 1.6868216 & 0.1730436 & 0.8631633\\
\hline
HealthIssuesyes & -0.6376131 & 1.3351218 & -0.4775692 & 0.6345839\\
\hline
LateralityUnilateral & -2.8895661 & 1.4111488 & -2.0476693 & 0.0447011\\
\hline
AmplificationCI & -1.4834084 & 2.2202887 & -0.6681151 & 0.5064625\\
\hline
AmplificationHA & -2.1973049 & 1.4372134 & -1.5288648 & 0.1312257\\
\hline
Communicationspoken & 0.9492343 & 4.6456058 & 0.2043295 & 0.8387444\\
\hline
Communicationtotal communication & 2.6833824 & 4.9137866 & 0.5460926 & 0.5869009\\
\hline
Meets136yes & -1.1566493 & 1.3053816 & -0.8860622 & 0.3789013\\
\hline
PrimaryLanguageSpanish & 1.6031624 & 1.7348679 & 0.9240833 & 0.3589140\\
\hline
HLworse & 0.0187295 & 0.0281002 & 0.6665240 & 0.5074720\\
\hline
Age & 0.5245000 & 0.0664205 & 7.8966564 & 0.0000000\\
\hline
\end{tabular}
\end{table}

This model accounted for significant variance in vocabulary delay (adjusted-R\textsuperscript{2} = 0.59, \emph{p} \textless{} .001; see Table \ref{tab:full-delay-betas}). We next performed stepwise model comparison using stepAIC (MASS) to pare down the model. This process selects only the predictors which incrementally improved model fit, measured by Akaike's Information Criterion (AIC), which considers goodness of fit and model complexity (penalizing models with many predictors). We started model selection with the full model, as described above. We then filtered out data from children for whom Meets 1-3-6 (n=5) or Degree (n = 13) was unknown, as this stepwise AIC approach does not permit missing values across predictors. Since this initial filtered analysis found that Degree did not improve model fit, we manually remove the Degree term from the model selection so that the 13 participants without Degree information could be retained.\footnote{ For transparency, we note that the model with only complete cases of Degree did include a non-significant main effect of Developmental Delay. However, ANOVA revealed that including a Developmental Delay term did not significantly improve model fit when including the 13 participants without Degree information.}

\begin{figure}
\centering
\includegraphics{ELSSP_paper_files/figure-latex/delay-beta-plot-1.pdf}
\caption{\label{fig:delay-beta-plot}Unstandardized beta weights (months of vocabulary delay) for the model of vocabulary delay selected by AIC: Vocabulary Delay \textasciitilde{} Age + Laterality + Amplification.}
\end{figure}

\begin{table}

\caption{\label{tab:delay-betas}Unstandardized beta weights (months of vocabulary delay) for the model of vocabulary delay selected by AIC: Vocabulary Delay ~ Age + Laterality + Amplification.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
\hline
(Intercept) & -0.5358566 & 1.7146748 & -0.3125121 & 0.7554545\\
\hline
LateralityUnilateral & -2.6985772 & 1.1372498 & -2.3728974 & 0.0200189\\
\hline
AmplificationCI & -3.5034202 & 1.4859023 & -2.3577730 & 0.0207969\\
\hline
AmplificationHA & -3.8355930 & 1.1347744 & -3.3800490 & 0.0011172\\
\hline
Age & 0.5493529 & 0.0558699 & 9.8327171 & 0.0000000\\
\hline
\end{tabular}
\end{table}
...
\caption{\label{tab:delay-vif}Generalized Variance Inflation Factor (GVIF) for the model of vocabulary delay selected by AIC: Vocabulary Delay ~ Age + Laterality + Amplification.}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & GVIF & Df\\
\hline
Laterality & 1.178895 & 1\\
\hline
Amplification & 1.200583 & 2\\
\hline
Age & 1.019896 & 1\\
\hline
\end{tabular}
...
\begin{figure}
\centering
\includegraphics{ELSSP_paper_files/figure-latex/diagnosis-beta-plot-1.pdf}
\caption{\label{fig:diagnosis-beta-plot}Unstandardized beta weights (months) for the model of age at diagnosis selected by AIC: Vocabulary Delay \textasciitilde{} Health Issues + Language Background + Laterality.}
\end{figure}

\begin{table}

\caption{\label{tab:diagnosis-betas}Unstandardized beta coefficients (months) for the model of age at diagnosis selected by AIC: Vocabulary Delay ~ Health Issues + Language Background + Laterality.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
...
\caption{\label{tab:diagnosis-vif}Variance Inflation Factor for diagnosis model: Vocabulary Delay ~ Health Issues + Language Background + Laterality.}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & VIF & Df\\
...
The best fit model was: Age at Diagnosis \textasciitilde{} Health Issues + Language Background + Laterality, with significant main effects of Health Issues and Language Background (see Table \ref{tab:diagnosis-betas}). This model accounted for 16.41\% of the variance in age at diagnosis (p = .001). Average age at diagnosis was 4.65 months. Relative to English-speaking families, children from Spanish-speaking families were diagnosed 6.47 months later (p = .001). Children with health issues were diagnosed 3.70 months later than children without health issues (p = .01).

\begin{figure}
\centering
\includegraphics{ELSSP_paper_files/figure-latex/intervention-beta-plot-1.pdf}
\caption{\label{fig:intervention-beta-plot}Unstandardized beta coefficients (months) for the model of age at intervention selected by AIC: Vocabulary Delay \textasciitilde{} Degree + Prematurity + Language Background + Age at Diagnosis.}
\end{figure}

\begin{table}

\caption{\label{tab:intervention-betas}Unstandardized beta coefficients (months) for the model of age at intervention selected by AIC: Vocabulary Delay ~ Degree + Prematurity + Language Background + Age at Diagnosis.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
term & estimate & std.error & statistic & p.value\\
...
\caption{\label{tab:intervention-vif}Variance Inflation Factor for the intervention model: Vocabulary Delay ~ Degree + Prematurity + Language Background + Age at Diagnosis.}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & VIF & Df\\
...
In our sample, 88.89\% of DHH children fell below the 50th percentile for spoken vocabulary. Moreover, of the 11.11\% who were at or above the 50th percentile, 55.56\% were 8-to-9-month olds who were not yet producing any words (as expected at this age). Finding that nearly 90\% of DHH children are below the 50th percentile for vocabulary development indicates that this group is not yet well-equipped to acquire spoken language. This disadvantage can have lasting consequences in the lives of DHH children (Karchmer \& Mitchell, 2003; Kyle \& Harris, 2010; Qi \& Mitchell, 2012), highlighting the importance of understanding what factors contribute to it.

In contrast to our predictions, the best model predicting vocabulary delay had just a few variables: age, amplification, and laterality. Notably, we did not simply find that DHH children were learning words at the same rate (albeit delayed) as hearing children, which would have led to a constant delay across developmental time. Instead, we see that the spoken vocabulary delay widens with age, indicating that the \emph{rate} of spoken vocabulary acquisition is slower for DHH children. The result is a population increasingly behind on spoken language milestones. Given that none of the children here use sign language (which can ensure earlier language access) this vocabulary delay is likely to have knock-on effects for language development more broadly as well. This in turn has policy implications that are critical to consider.
...
Language background too predicted age at diagnosis. Infants from Spanish-speaking families were diagnosed 3.78 months later than infants from English-speaking families. This may be due to cultural differences in attitudes towards deafness (Caballero, Muñoz, Schultz, Graham, \& Meibos, 2018; Rodriguez \& Allen, 2020; Steinberg, Bain, Li, Delgado, \& Ruperto, 2003; Steinberg, Dávila, Collazo, Loew, \& Fischgrund, 1997) or it may result from a lack of linguistically accessible and culturally appropriate audiology services. Only 5.6\% of American audiologists identify as bilingual service providers (ASHA, 2019), and services from a monolingual provider may be insufficient. To this point, Caballero et al. (2017) found that Hispanic-American parents of DHH children wish for more concrete resources, comprehensive information, and emotional support from their audiologist. In a nationwide survey of audiologists, the majority of audiologists reported that language barriers presented a major challenge in working with Spanish-speaking families, specifically in obtaining the child's case history and providing recommendations for follow-up services(Abreu, Adriatico, \& DePierro, 2011).
...
<!-- eb2ec: this last bullet is one reason to maybe keep the paragraph i nixed but i think you can have this bullet but still nix the para -->
\end{enumerate}

...
\caption{\label{fig:beta-plots}Unstandardized beta weights (months) for the models of (A) vocabulary delay, (B) age at diagnosis, (C) age, selected by AIC. A: ; B: Age at Diagnosis \textasciitilde{} Health Issues + Language Background + Laterality; C: Age at Intervention \textasciitilde{} Degree + Prematurity + Language Background + Age at Diagnosis.}
\end{figure}

...
The best fit model (R2=0.25 , p=0.00 )included health issues (B = 4.18, p = 0.0028) and language background (B = 27.68, p = 3.8e-05).
...
The best fit model (R2=0.46 , p=0.00) included prematurity (B = 4.6, p = 0.02), degree of hearing loss (B = -0.09, p = 0.0039), and age at diagnosis (B = 0.68, p = 1e-09).

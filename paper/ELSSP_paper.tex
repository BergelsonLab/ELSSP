...
\hline
WS (n=23) & 25.96 (7.95) months & NA & 139 (178.3) words & 4.35\%\\
\hline
\end{tabular}}
\end{table}
...
\hline
Developmental Delay & Yes: NaN; No: NaN & Yes: NaN; No: NaN & wilcox\\
\hline
...
The best fit model (R2=0.25 , p=0.00 )included health issues (ß = 4.18, p = 0.0028) and language background (ß = 27.68, p = 3.8e-05).
...
The best fit model (R2=0.46 , p=0.00) included prematurity (ß = 4.6, p = 0.02), degree of hearing loss (ß = -0.09, p = 0.0039), and age at diagnosis (ß = 0.68, p = 1e-09).

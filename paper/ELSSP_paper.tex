...
\hline
Hearing Aid (n=54) & 11 / 43 & 4.7 / 47.02 dB & 56.04 / 55.57 dB & 10.91 / 8.28 months\\
\hline
Cochlear Implant (n=17) & 0 / 17 & NA / 85.6 dB & NA / 89.79 dB & NA / 14.12 months\\
\hline
No Amplification (n=27) & 14 / 13 & 2.5 / NA dB & 73.9 / NA dB & NA\\
\hline
Total (n=100) & 25 / 73 & 3.47 / 56.84 dB & 66.54 / 63.55 dB & NA\\
\hline
...
For categorical-categorical relationships, we used chi square tests; for continuous-categorical tests, we used mann-whitney U tests (2 levels for categorical variable) or kruskal-wallis tests (\textgreater{}2 levels for categorical variable; for continuous-continuous relationships, we used Of the fifty-five combinations of variables, p \textless{} .05 for sixteen, and seven survived bonferroni correction (p \textless{} 0.00091). The full set of comparisons is shown in figure XXX.

\includegraphics{ELSSP_paper_files/figure-latex/relationships-plot-1.pdf} \includegraphics{ELSSP_paper_files/figure-latex/relationships-plot-2.pdf} \includegraphics{ELSSP_paper_files/figure-latex/relationships-plot-3.pdf}

From this analysis, we found that children born premature were more likely to also have health issues (\(X^2\) (1, N = 98) = 23.9, p = 1e-06). Children with conductive hearing loss were more likely to have unilateral hearing loss (\(X^2\) (2, N = 88) = 18.29, p = 0.00011). Children with unilateral hearing loss were unlikely to receive a cochlear implant and more likely to use no amplification (\(X^2\) (2, N = 98) = 16.43, p = 0.00027). Children with more severe hearing loss were more likely to use a cochlear implant than children with milder hearing loss (\(X^2\) (4, N = 87) = 28.45, p = 1e-05). Children with developmental delays received more services per month than typically developing DHH children (\(X^2\) (2, N = 95) = 19.48, p = 5.9e-05) and were more likely to use total communication (\(X^2\) (2, N = 98) = 22.51, p = 1.3e-05). Children who used total communication received more services per month than children using spoken language (\(X^2\) (4, N = 95) = 16.67, p = 0.0022).
...
\hline
Health Issues & Yes: 12.9; No: 13.9 & wilcox\\
\hline
Developmental Delay & Yes: 21.4; No: 12.1 & wilcox\\
\hline
Prematurity & Premature: 17.2; Full-term: 12.9 & wilcox\\
\hline
...
Lastly, we looked at the ages at which children received diagnosis and intervention, and how this mapped onto the 1-3-6 guidelines. Overall, 36.84\% of our sample met 1-3-6 guidelines for early diagnosis and intervention.
